...
export const suppliers: Supplier[] = [
  ...
  { id: 'SUP-003', name: 'EuroChem Supply Co.', contactPerson: 'Klaus Weber', email: 'weber@eurochem.de', phone: '+49 89 4444 5678', location: 'Munich, Germany', address: 'Industriestraße 22, 80939 Munich, Germany', taxRegNumber: 'DE-298745612', preferred: true, passwordHash: 'supplier123', active: true, kpis: { priceVariation: 2.1, deliveryPerformance: 98, paymentTerms: 'Net 60', onTimePayment: 100, responseTime: 2, deliveryTerms: 'DDP', rejectionRate: 0.5 }, notes: [] },
  { id: 'SUP-004', name: 'IndoTech Materials', contactPerson: 'Ravi Patel', email: 'ravi@indotech.in', phone: '+91 22 6666 7890', location: 'Mumbai, India', address: 'Unit 5B, MIDC Andheri East, Mumbai 400093, India', taxRegNumber: 'GSTIN-27AACCI4906R1ZP', preferred: false, passwordHash: 'supplier123', active: true, kpis: { priceVariation: 7.4, deliveryPerformance: 81, paymentTerms: 'Net 30', onTimePayment: 85, responseTime: 12, deliveryTerms: 'EXW', rejectionRate: 4.8 }, notes: [{ id: 'NOTE-004', text: 'High rejection rate flagged. Corrective action requested.', date: '2026-02-14', author: 'QA Manager' }] },
  { id: 'SUP-005', name: 'AmeriSteel Corp', contactPerson: 'Mike Johnson', email: 'mike@ameristeel.us', phone: '+1 713 555 9876', location: 'Houston, USA', address: '10200 W Sam Houston Pkwy S, Houston, TX 77099, USA', taxRegNumber: 'EIN-82-3456789', preferred: true, passwordHash: 'supplier123', active: true, kpis: { priceVariation: 4.0, deliveryPerformance: 91, paymentTerms: 'Net 30', onTimePayment: 95, responseTime: 6, deliveryTerms: 'FCA', rejectionRate: 2.0 }, notes: [] },
  { id: 'SUP-006', name: 'NipponValve Ltd.', contactPerson: 'Yuki Tanaka', email: 'tanaka@nipponvalve.jp', phone: '+81 3 7777 1234', location: 'Tokyo, Japan', address: '3-1-2 Nihonbashi, Chuo-ku, Tokyo 103-0027, Japan', taxRegNumber: 'JP-T1234567890123', preferred: true, passwordHash: 'supplier123', active: true, kpis: { priceVariation: 1.8, deliveryPerformance: 99, paymentTerms: 'Net 45', onTimePayment: 100, responseTime: 3, deliveryTerms: 'DAP', rejectionRate: 0.3 }, notes: [{ id: 'NOTE-005', text: 'Exceptional 2025 performance. Nominated for Supplier of the Year.', date: '2026-01-20', author: 'Procurement Manager' }] },
  { id: 'SUP-007', name: 'TechServ Engineering', contactPerson: 'Omar Hassan', email: 'omar@techserv.ae', phone: '+971 4 888 2200', location: 'Abu Dhabi, UAE', address: 'Office 302, Khalifa Business Park, Abu Dhabi, UAE', taxRegNumber: 'TRN-104567890100005', preferred: true, passwordHash: 'supplier123', active: true, kpis: { priceVariation: 2.5, deliveryPerformance: 96, paymentTerms: 'Net 30', onTimePayment: 98, responseTime: 2, deliveryTerms: 'N/A', rejectionRate: 0.8 }, notes: [] },
